FROM gcr.io/bazel-public/bazel:8.2.0

WORKDIR /app

USER root
#copied from the official haskell docker image
#https://github.com/haskell/docker-haskell/blob/e7f56b0064dea2d53541ca85a9b2d2cb82cf8c13/9.12/slim-bookworm/Dockerfile
###############################################################################################################################
